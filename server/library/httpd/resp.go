...
func (r *Resp) StatusAccepted() error {
	r.WriteHeader(http.StatusAccepted)
	return nil
}

func (r *Resp) RespWithStatus(status int) error {
...
func (r *Resp) ErrorWithText(text string, status int) error {
	return r.Error(text, status)
}
...
func (r *Resp) JSONError(src interface{}) error {
	return r.JSONStatus(src, http.StatusInternalServerError)
}
